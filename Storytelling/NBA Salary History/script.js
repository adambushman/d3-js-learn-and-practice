...
const renderSVG = (dims, id) => {
    const svg = d3.select(id)
        .append("svg")
        .attr("viewBox", `
        0 0 ${dims.width + dims.left + dims.right} ${dims.height + dims.top + dims.bottom}
        `)
        .append("g")
...
const dims1 = {width: 500, height: 300, top: 10, bottom: 10, left: 10, right: 10, padding: 10};
const dims2 = {width: 500, height: 500, top: 10, bottom: 10, left: 10, right: 10, padding: 10};
const margins = {top: 10, bottom: 10, left: 10, right: 10, padding: 10};

const svg1 = renderSVG(dims1,"#chart-1");
const svg2 = renderSVG(dims2,"#chart-1");
