...
function extractPixelColors(imagePath) {
  ...
  // Function to display extracted pixel colors
  function displayPixelColors(colors) {
    const pixelColorsDiv = document.getElementById('pixelColors');
    ...
    colors.forEach(color => {
      ...
      pixelColorsDiv.appendChild(colorBox);
    });
  }
